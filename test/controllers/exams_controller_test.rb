...
class ExamsControllerTest < ActionController::TestCase
  ...
  test "should create exam" do
    assert_difference('Exam.count') do
      post :create, exam: { expires_on: @exam.expires_on, item_quantity: @exam.item_quantity, time_limit: @exam.time_limit, title: @exam.title }
    end
  ...
  test "should update exam" do
    patch :update, id: @exam, exam: { expires_on: @exam.expires_on, item_quantity: @exam.item_quantity, time_limit: @exam.time_limit, title: @exam.title }
    assert_redirected_to exam_path(assigns(:exam))
  end
